...
$exifTags = $exifTagReader->read(__DIR__.'/.data/example-ComponentsConfiguration.jpeg');
...
$exifTags = $exifTagReader->read(__DIR__.'/.data/example-GPSCoordinates.jpeg');
...
$exifTags = $exifTagReader->read(__DIR__.'/.data/example-SceneType.jpeg');
